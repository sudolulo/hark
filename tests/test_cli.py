...
def test_rate_shows_without_taddy_credentials_only_runs_backfill(tmp_path, capsys, monkeypatch):
    ...
    def boom(*a, **k):
        raise AssertionError("refresh_ratings should not be called without credentials")
...
def test_rate_shows_with_only_one_taddy_var_set_only_runs_backfill(tmp_path, capsys, monkeypatch):
    ...
    def boom(*a, **k):
        raise AssertionError("refresh_ratings should not be called with only one of the two vars set")
