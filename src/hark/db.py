...
# are the ad-stripping pipeline (M2-M4, merged in from the standalone adscrub repo
# — see docs/PLAN.md). feed_token gates the unauthenticated /feed and /audio routes
# (podcast apps can't do the dashboard's cookie login); every show gets one via
# _backfill_feed_tokens, not just ones added after this merge.
SCHEMA = """
